...
fetch('/user/home/protein/chart')
            ...
            .then(totalProtein => {
                ...
                if (totalProtein < 1000) {
                    barColor = 'rgba(255, 255, 0, 0.7)';  
                    borderColor = 'rgba(255, 255, 0, 1)';
                } else if (totalProtein >= 1000 && totalProtein <= 2000) {
                ...
                const proteinChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                                    ...
                                    labels: {
                                        total: {
                                            align: function(value, context) {
                                                if (totalProtein  < 1200 || 2800 < totalProtein) {
                                                    return 'top';
                                                } else {
                                                    return 'bottom';
                                                }
                            ...
                            {
                                data: [[ totalProtein,2000 ]],
                                borderColor: function(){
                                    if (totalProtein < 2000) {
                                ...
                                datalabels: {
                                    ...
                                    labels: {
                                        ...
                                        calories2: {
                                            ...
                                            formatter: function(value, context) {
                                                if (300 < totalProtein && totalProtein <= 1000) {
                                                    return "      " +value[0].toFixed(0)+ "kcal";
                                                }else if (totalProtein <= 300){
                                                    return "            " +value[0].toFixed(0)+ "kcal";
                                                }else {
                                                    return " ";
                                                }                                        
