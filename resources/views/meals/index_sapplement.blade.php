...
<head>
  ...
  <title>Meal Registration Sapplement</title>
...
<body>
  <div class="container mt-5">
    <div class="underline-container">
      <h2 class="underline text-left">Meal Registration Sapplement</h2>
    </div>
    <form id="mealForm" action="{{ route('meals.store.sapplement') }}" method="POST">
      @csrf
...
//     }).then(data => {
//         if (data.success) {
//             // 登録が成功した場合、confirmation_sapplementページへリダイレクト
//             window.location.href = "{{ route('meals.confirmation_sapplement') }}?totalCalories=" + totalCalories;
//         } else {
